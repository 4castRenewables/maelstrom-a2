...
poetry run python ../../relevance_classifier/predict_deberta_classifier.py \
    ...
    --path_raw_model /home/kristian/Projects/a2/models/electra-base-discriminator \
    --path_trained_model /tmp/test_relevance_classifier_electra/rain_classification/checkpoint-2 \

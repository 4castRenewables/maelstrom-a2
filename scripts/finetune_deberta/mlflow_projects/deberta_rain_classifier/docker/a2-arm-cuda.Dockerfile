...
COPY scripts/finetune_deberta/mlflow_projects/deberta_rain_classifier/requirements_arm_cuda.txt /opt/deberta_rain_classifier/
...
RUN pip install -r requirements_arm_cuda.txt
